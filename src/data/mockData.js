...
export const mockAktivitas = [
  { id: 1, icon: 'calendar', title: 'Jadwal Elf Long diperbarui', desc: 'Admin mengubah rute ke Demak.', waktu: '10 MENIT LALU', color: 'blue' },
  { id: 2, icon: 'payment', title: 'Pembayaran menunggu validasi', desc: 'Inv-00234 butuh persetujuan.', waktu: '1 JAM LALU', color: 'orange' },
  { id: 3, icon: 'check', title: 'Data armada Truk CDD diperbarui', desc: 'Admin memperbarui status armada.', waktu: '2 JAM LALU', color: 'green' },
  { id: 4, icon: 'info', title: 'Permintaan jadwal baru masuk', desc: 'Pemesanan rute Grobogan - Solo.', waktu: '3 JAM LALU', color: 'purple' },
  { id: 5, icon: 'calendar', title: 'Pembaruan Data Jadwal', desc: 'Jadwal Bus Medium diperbarui.', waktu: '5 JAM LALU', color: 'blue' },
  { id: 6, icon: 'payment', title: 'Pembayaran tervalidasi', desc: 'Inv-00230 lunas oleh Rizky.', waktu: '6 JAM LALU', color: 'green' },
  { id: 7, icon: 'info', title: 'Laporan armada masuk', desc: 'Truk CDD butuh perawatan.', waktu: '8 JAM LALU', color: 'orange' },
  { id: 8, icon: 'check', title: 'Sopir baru ditambahkan', desc: 'Eko Wahyudi ditambahkan ke sistem.', waktu: 'KEMARIN', color: 'purple' },
  { id: 9, icon: 'calendar', title: 'Jadwal Selesai', desc: 'Bus Medium tiba di Semarang.', waktu: 'KEMARIN', color: 'green' },
  { id: 10, icon: 'payment', title: 'Permintaan Refund', desc: 'Pembatalan jadwal oleh pelanggan.', waktu: '2 HARI LALU', color: 'orange' },
];

export const mockChartData = [
  { hari: 'Min', busMedium: 5, elfLong: 3, trukCDD: 8 },
  { hari: 'Sen', busMedium: 8, elfLong: 5, trukCDD: 10 },
  { hari: 'Sel', busMedium: 12, elfLong: 7, trukCDD: 14 },
  { hari: 'Rab', busMedium: 15, elfLong: 9, trukCDD: 16 },
  { hari: 'Kam', busMedium: 14, elfLong: 8, trukCDD: 15 },
  { hari: 'Jum', busMedium: 18, elfLong: 11, trukCDD: 18 },
  { hari: 'Sab', busMedium: 20, elfLong: 13, trukCDD: 15 },
];

export const mockJadwalTerbaru = [
  { tanggal: '20 Mei, 08:00', armada: 'Bus Medium', plat: 'H 1234 AA', rute: 'Grobogan → Semarang', status: 'Tersedia' },
  { tanggal: '20 Mei, 10:30', armada: 'Elf Long', plat: 'H 5678 BB', rute: 'Grobogan → Yogyakarta', status: 'Dipesan' },
  { tanggal: '21 Mei, 09:00', armada: 'Truk CDD', plat: 'H 9012 CC', rute: 'Pengiriman Pasir - Grobogan', status: 'Dalam Perjalanan' },
  { tanggal: '21 Mei, 14:00', armada: 'Truk CDD', plat: 'H 7890 EE', rute: 'Pengiriman Palawija - Purwodadi', status: 'Selesai' },
  { tanggal: '22 Mei, 08:00', armada: 'Bus Medium', plat: 'H 1234 AA', rute: 'Grobogan → Solo', status: 'Tersedia' },
];

export const mockLaporan = [
  { id: 'RPT-001', tanggal: '2026-05-01', jenis: 'Bus Medium', rute: 'Grobogan → Semarang', pelanggan: 'Rizky Pratama', pendapatan: 'Rp 1.500.000', status: 'Selesai' },
  { id: 'RPT-002', tanggal: '2026-05-03', jenis: 'Elf Long', rute: 'Grobogan → Solo', pelanggan: 'Dewi Rahayu', pendapatan: 'Rp 950.000', status: 'Selesai' },
  { id: 'RPT-003', tanggal: '2026-05-07', jenis: 'Truk CDD', rute: 'Pengiriman Pasir - Grobogan', pelanggan: 'Ahmad Fauzi', pendapatan: 'Rp 600.000', status: 'Selesai' },
  { id: 'RPT-004', tanggal: '2026-05-10', jenis: 'Bus Medium', rute: 'Grobogan → Yogyakarta', pelanggan: 'Sari Indah', pendapatan: 'Rp 1.800.000', status: 'Selesai' },
  { id: 'RPT-005', tanggal: '2026-05-14', jenis: 'Truk CDD', rute: 'Pengiriman Palawija - Purwodadi', pelanggan: 'Joko Susanto', pendapatan: 'Rp 500.000', status: 'Selesai' },
  { id: 'RPT-006', tanggal: '2026-05-18', jenis: 'Elf Long', rute: 'Grobogan → Semarang', pelanggan: 'Bagus Wicaksono', pendapatan: 'Rp 950.000', status: 'Selesai' },
];
